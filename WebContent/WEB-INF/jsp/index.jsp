        ...
        <div class="con clearfix">
                    ...
                    <div class="col-xs-12 hot-tj-con">
                        ...
                        <div id="hotNewTab" style="overflow:hidden;">
                            <div class="hot-con swipe-wrap">
                                ...
                                <ul>
                                    <li class="clearfix"><span class="num num-color">01</span><a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${hotRank.forumId1}/0/0/1/0.htm" class="title"><img src="${hotRank.icon1}" alt="">${hotRank.forumName1} </a>
	                                    <span class="rank">
                                    ...
                                    <li class="clearfix"><span class="num num-color">02</span><a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${hotRank.forumId2}/0/0/1/0.htm" class="title"><img src="${hotRank.icon2}" alt="">${hotRank.forumName2}</a>
                                    <span class="rank">
                                    ...
                                    <li class="clearfix"><span class="num num-color">03</span><a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${hotRank.forumId3}/0/0/1/0.htm" class="title"><img src="${hotRank.icon3}" alt="">${hotRank.forumName3}</a>
                                    	<span class="rank">
                                    ...
                                    <li class="clearfix"><span class="num">04</span><a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${hotRank.forumId4}/0/0/1/0.htm" class="title"><img src="${hotRank.icon4}" alt="">${hotRank.forumName4}</a>
                                    	<span class="rank">
                                    ...
                                    <li class="clearfix"><span class="num">05</span><a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${hotRank.forumId5}/0/0/1/0.htm" class="title"><img src="${hotRank.icon5}" alt="">${hotRank.forumName5}</a>
                                    	<span class="rank">
                                ...
                                <ul>
                                    <li class="clearfix"><a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${recommendRank.forumId1}/0/0/1/0.htm" class="title"><img src="${recommendRank.icon1}" alt="">${recommendRank.forumName1}</a>
                                    <span>
                                    ...
                                    <li class="clearfix"><a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${recommendRank.forumId2}/0/0/1/0.htm" class="title"><img src="${recommendRank.icon2}" alt="">${recommendRank.forumName2}</a>
                                    <span>
                                    ...
                                    <li class="clearfix"><a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${recommendRank.forumId3}/0/0/1/0.htm" class="title"><img src="${recommendRank.icon3}" alt="">${recommendRank.forumName3}</a>
                                    <span>
                                    ...
                                    <li class="clearfix"><a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${recommendRank.forumId4}/0/0/1/0.htm" class="title"><img src="${recommendRank.icon4}" alt="">${recommendRank.forumName4}</a>
                                    <span>
                                    ...
                                    <li class="clearfix"><a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${recommendRank.forumId5}/0/0/1/0.htm" class="title"><img src="${recommendRank.icon5}" alt="">${recommendRank.forumName5}</a>
                                    <span>
           ...
           <div class="h2-con clearfix container">
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                       <a target="_blank" href="<%=CommonUrl.baseUrl %>/forum_content/${officalForum.forumId1}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                       <a target="_blank" href="<%=CommonUrl.baseUrl %>/forum_content/${officalForum.forumId2}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   	   <a target="_blank" href="<%=CommonUrl.baseUrl %>/forum_content/${officalForum.forumId3}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   	   <a target="_blank" href="<%=CommonUrl.baseUrl %>/forum_content/${officalForum.forumId4}/0/0/1/0.htm">
           ...
           <div class="h2-con clearfix container">
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${hotForum.hotForumId1}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${hotForum.hotForumId2}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${hotForum.hotForumId3}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${hotForum.hotForumId4}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${hotForum.hotForumId5}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${hotForum.hotForumId6}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${hotForum.hotForumId7}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${hotForum.hotForumId8}/0/0/1/0.htm">
           ...
           <div class="h2-con clearfix container">
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${recommendForum.forumId1}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${recommendForum.forumId2}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfixf">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${recommendForum.forumId3}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${recommendForum.forumId4}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${recommendForum.forumId5}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${recommendForum.forumId6}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${recommendForum.forumId7}/0/0/1/0.htm">
               ...
               <div class="col-xs-3 col-md-4  col-sm-6">
                   <dl class="clearfix">
                   <a target="_blank"  href="<%=CommonUrl.baseUrl %>/forum_content/${recommendForum.forumId8}/0/0/1/0.htm">

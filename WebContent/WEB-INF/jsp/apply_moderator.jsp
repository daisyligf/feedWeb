                    ...
                    <div class="feed-user-apply-hd clearfix">
                        ...
                        <c:choose>
	                        ...
	                        <div class="apply-hd-main">
	                            <h3 class="apply-hd-title">立即申请 <span class="apply-title-item">您在在申请 <a href="forum_content/${feedForum.forum_id}/0/0/1/0.html" class="apply-link" target="_blank">${feedForum.forum_name }</a> 吧主</span></h3>

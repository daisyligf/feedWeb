            ...
            <div class="col-xs-3 user-info-out">
                <div class="user-info">
                   <dl>
                    ...
                    <ul class="clearfix">
                        <li class="col-xs-4"><span><a href="<%=UserCenter.baseUrl %>/home/public/mythreads?to_uid=${threadUserInfo.userId}">${threadUserInfo.threads}</a></span>帖子</li>
                        <li class="col-xs-4"><span><a href="<%=UserCenter.baseUrl %>/home/public/myreply?to_uid=${threadUserInfo.userId}">${threadUserInfo.replies}</a></span>回复</li>

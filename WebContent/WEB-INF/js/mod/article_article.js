...
define('article_article',['jquery','handlebars','jquery/jquery-pagebar','jquery/jquery-pop','loginUserUrl','config'],function(require, exports, module) {
	...
	var deleteHrefUrl = c.config.baseUrl + "/forum/"+$("#getPostData").attr("data-fid") + "/0/0/1/0.html";//删除帖子跳转的路径
	...
	if(USE_TEST_DATA){
		...
		deleteHrefUrl = c.config.baseUrl + "/forum/"+$("#getPostData").attr("data-fid") + "/0/0/1/0.html";//删除帖子跳转的路径
	}

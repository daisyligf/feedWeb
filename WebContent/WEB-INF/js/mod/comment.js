...
define("comment",["jquery",'handlebars','jquery/jquery-pop','jquery/jquery-form','config'],function(require, exports, module) {
    ...
    if($("#editor-form .editor-fid").length>0){
        var localPlateUrl = c.config.base_url + "/forum/"+$("#editor-form .editor-fid").val() + "/0/0/1/0.html";//发帖成功，跳转的路径
        var localPostUrl = c.config.base_url + "/thread/"+$("#editor-form .editor-tid").val() + "/1/0/0.html";//编辑帖子成功，跳转的路径
    }
    ...
    if(USE_LOCAL_DATA){
        ...
        if($("#editor-form .editor-fid").length>0){
            localPostUrl = c.config.base_url + "/thread/"+$("#editor-form .editor-tid").val() + "/1/0/0.html";//发帖成功，跳转的路径
            localPlateUrl = c.config.base_url + "/forum/"+$("#editor-form .editor-fid").val() + "/0/0/1/0.html";//编辑帖子成功，跳转的路径
        }

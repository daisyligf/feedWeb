...
<head>
    ...
    <link rel="stylesheet" href="/static/feedweb/js/editor/css/umeditor.css">
    <link rel="stylesheet" href="/static/feedweb/js/editor/css/fixeditor.css">
    <link rel="stylesheet" href="/static/feedweb/js/editor/emotion.css">

    <link rel="stylesheet" href="/static/feedweb/css/common.css">
    <link rel="stylesheet" href="/static/feedweb/css/article_article.css">
    ...
    <script src="/static/feedweb/js/editor/js/jquery.min.js"></script>
    <script src="/static/feedweb/js/editor/js/umeditor.config.js"></script>
    <script src="/static/feedweb/js/editor/js/umeditor.js"></script>
    <script src="/static/feedweb/js/editor/lang/zh-cn/zh-cn.js"></script>
    <script src="/static/feedweb/js/editor/btn.js"></script>
    <script src="/static/feedweb/js/editor/feed-emotion.js"></script>
...
<body>
    <div class="page">
            ...
            <div class="col-xs-3 user-info-out">
                <div class="user-info">
                   <dl>
                        ...
                        <dd class="money"><s class="icon-money"></s>${threadUserInfo.coin} <a href="http://app.mofang.com/" target="_blank"><s class="icon-mailbox"></s></a></dd>
                    </dl>
                    <ul class="clearfix">
            ...
            <div class="col-xs-9 col-md-12" id="getPostData" data-tid="${feedThread.thread_id}" data-uid="${threadUserInfo.userId }" data-fid="${feedForum.forum_id }" data-isclosed="${feedThread.isClosed}">
                <div class="con-right1 clearfix">
                    <dl class="con-author clearfix">
                        ...
                        <dd class="author-name"><a href="<%=UserCenter.baseUrl %>/home/public/info?to_uid=${threadUserInfo.userId}">${threadUserInfo.nickname}</a><a href="http://app.mofang.com" target="_blank"><s class="icon-mailbox"></s></a><a href="<%=CommonUrl.baseUrl%>/level_info"><span class="grade">Lv.${threadUserInfo.level}</span></a></dd>
                        <dd class="author-detail"><b>楼主</b></dd>
                    </dl>
                    ...
                    <h3>楼主  <a href="<%=UserCenter.baseUrl %>/home/public/info?to_uid=${threadUserInfo.userId}" target="_blank">${threadUserInfo.nickname}</a></h3>
                    <div class="con-con">
                   ...
                   <p class="look" data-tid="${feedThread.thread_id }">
                    ...
                    <p class="date">
                        <c:if test="${feedThread.create_time != feedThread.update_time}">
                            编辑于 <fmt:formatDate value="${feedThread.update_time}" type="both" pattern="${feedThread.format}"/> 
                        </c:if>
                        <c:if test="${feedThread.create_time == feedThread.update_time}"> 
                            发表于 <fmt:formatDate value="${feedThread.update_time}" type="both" pattern="${feedThread.format}"/>
                        </c:if>
                ...
                <div class="con-right2" id="conRight2">
                    <!-- 楼层回复模板1 -->
                    <script id="floorCommentTemplate" type="application/x-handlebars-template">
                        {{#each this}}
                        <dl class="clearfix">
                            ...
                            <dd class="autor">{{timeformat create_time}}     {{#if deleteFlg}}
                                <a href="javascript:;" class="shanchu" data-cid="{{cid}}">删除</a>
                                {{/if}}  <a href="javascript:;" class="dianping" data-name="{{nickname}}" data-uid="{{uid}}" data-tid="{{tid}}">回复</a></dd>
                        </dl>
                        {{/each}} 
                    </script>
                    <!-- 楼层回复模板2 -->
                    <script id="floorCommentTemplate2" type="application/x-handlebars-template">
                        ...
                        <dl class="clearfix">
                            ...
                            <dd class="autor">{{timeformat create_time}}     
                                <a href="javascript:;" class="shanchu" data-cid="{{cid}}">删除</a>
                                <a href="javascript:;" class="dianping" data-name="{{user.nickname}}" data-uid="{{uid}}" data-tid="{{tid}}">回复</a></dd>
                        </dl>
                    </script>
                    ...
                    <div class="con-list" id="floor${feedPost.post_id}" data-postid="${feedPost.post_id}" data-uid="${feedPost.postUserInfo.userId}"   data-page='1'>
                        ...
                        <div class="con-list-right">
                            <dl class="list-right-dl">
                                ...
                                %> 
                                    <div class="floor-manage">楼层管理
    		                            <div class="manage-more clearfix">
                                            ...
                                            <a href="javascript:;" class="list-edit">编辑</a>
    		                                <a href="javascript:;" class="floor-manage-reward">奖励</a>
    		                            </div>
    		                        </div>
                                    <a href="javascript:;" class="cls-edit list-edit">编辑楼层</a>
		                        <%} else {%>
                                ...
                                <%} %>
                                <a href="<%=UserCenter.baseUrl %>/home/public/info?to_uid=${feedPost.postUserInfo.userId}" target="_blank">${feedPost.postUserInfo.nickname }</a><a href="http://app.mofang.com" target="_blank"><s class="icon-mailbox"></s></a><a href="<%=CommonUrl.baseUrl%>/level_info"><span class="grade">Lv.${feedPost.postUserInfo.level}</span></a></dt>
                                ...
                                <dd class="clearfix">
                                    ...
                                    <p class="date">
                                        ...
                                        <c:if test="${feedPost.create_time != feedPost.update_time}"> 
                                            编辑于 <fmt:formatDate value="${feedPost.update_time}" type="both" pattern="${feedPost.format}"/></p>
                                        </c:if>
                                        <c:if test="${feedPost.create_time == feedPost.update_time}">
                                            发表于 <fmt:formatDate value="${feedPost.create_time}" type="both" pattern="${feedPost.format}"/></p>
                                        </c:if>
               ...
               <div class="con-right3 reply-textarea"  id="conRight3">
                   <div class="reply-textarea-info clearfix">
                       ...
                       <c:choose>
                       	...
                       	<a href="#"><img src="/static/feedweb/img/default.png" alt="">
                       	</a>
                       	</c:when>
                       	<c:otherwise>
                       ...
                       <dl>
                           ...
                           <form id="editor-form" data-form="replayPost" data-tid="${feedThread.thread_id }" action="<%=CommonUrl.baseUrl%>/send_reply.json" method="POST" data-isReply="1">
                               <input type="hidden" name="fid" class="editor-fid" value="${feedForum.forum_id }"/>
                               <input type="hidden" name="pid" class="editor-pid" value=""/>
                   ...
                   <p class="replay-floor"><span class="edit-ing">编辑中...&nbsp;&nbsp;</span><span class="word-count">还可以输入5000字</span> <input type="button" class="reply-editer reply-submit" value="回复"></p>
               </div>
               </c:when>
               <c:otherwise>
        ...
        <div class="pop pop-post-delete">
            <h2 class="clearfix">
                <span>
                    <img src="/static/feedweb/img/icon/pop_close.png" class="close">
                </span>帖子管理操作
            </h2>
        ...
        <!--确定删除？-->
        <div class="pop pop-play pop-del">
            <p class="pop-play-close"><img src="/static/feedweb/img/icon/pop_close.png" class="close"></p>
            <p class="pop-play-word pop-msg">确定删除？</p>
            <p class="clearfix">
                <input type="button" class="pop-play-cancel pop-cancel" value="放弃">
    ...
    <script src="/static/feedweb/js/mod/article_article.js"></script>
    <script src="/static/feedweb/js/mod/comment.js"></script>
    <!-- 苹果广告联盟令牌JS(footer.jsp已经全加) -->

...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
    <link rel="stylesheet" href="/static/feedweb/css/footer_link.css">
 	 ...
 	 <div class="footer-con">
	 	 <div class="footer-nav clearfix width-1280">	
	    	...
	    	<div class="footer-nav-list clearfix">
	    		...
	    		<dl class="last-dl">
	    			<dt><a target="_blank" href="javascript:void(0);"><img src="/static/feedweb/img/footer_logo.png" alt=""></a></dt>

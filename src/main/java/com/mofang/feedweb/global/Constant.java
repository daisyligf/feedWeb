...
public class Constant {
	...
	// 版块标签
	public static final String FORUM_TAG_LIST_URL = "feed/v2/web/forum/taglist"; // 帖子详情
	public static final String THREAD_INFO_URL = "feed/v2/web/thread/info"; // 帖子-编辑更新
